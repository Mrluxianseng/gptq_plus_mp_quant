"""Shared contracts for the Qwen3-4B FA4-side true-tensor replay.
...
OUTPUT_ROOT = DATA_ROOT / "realq_fa4_q4_fa4side_tensor_replay_20260822_v1"
...
# Immutable math-SDPA-side capture from the immediately preceding v2 replay.
# The FA4-side campaign compares its layer-6 Q/K/V/dO against these exact
# values, in addition to replaying the FA4-side values through every local arm.
SDPA_TRAJECTORY_CAPTURE_ROOT = (
    DATA_ROOT
    / "realq_fa4_q4_true_tensor_replay_20260822_v2/capture/capture"
)
SDPA_TRAJECTORY_CAPTURE_RECEIPT = (
    SDPA_TRAJECTORY_CAPTURE_ROOT / "capture_receipt.json"
)
SDPA_TRAJECTORY_CAPTURE_RECEIPT_SHA256 = (
    "2f976071340d46b70548c28cab216b43d47929d9825f1fec0f3b436a3c551f2a"
)
SDPA_TRAJECTORY_PLAN_FINGERPRINT = (
    "4ed118476151199c25db3453847783c8a449186f4d1d9f47485ae74ba4114de5"
)
