#!/usr/bin/env python3
"""Noise-aware LR analysis/freeze gate for the corrected all-one V4."""
...
from experiments.realq_fullmodel_retune_20260817 import campaign_v4 as v4
...
SELECTION_ID = "realq-fullmodel-two-branch-lr-selection-20260817-v4"
SELECTION_PATH = v4.OUTPUT_ROOT / "selections.json"
...
def _freeze(_: argparse.Namespace) -> int:
    ...
    body: dict[str, Any] = {
        ...
        "campaign_id": v4.CAMPAIGN_ID,
        "protocol_fingerprint": plan["protocol_fingerprint"],
        "plan": {"path": str(v4.PLAN_PATH), "sha256": c._file_sha256(v4.PLAN_PATH)},
        "selection_code": [
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    try:
        ...
        print(f"realq-fullmodel-selection-v4: {exc}", file=sys.stderr)
        return 2
