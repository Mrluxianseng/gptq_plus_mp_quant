#!/usr/bin/env python3
"""Checkpoint-only KL/PPL and ten-task QA for SDPA V2b checkpoints."""
...
core = immutable.core
QUALITY_ID = "realq-sdpa-frozen-run15-lr20-quality-20260822-v2b-memory"
QUALITY_PLAN_PATH = campaign.OUTPUT_ROOT / "quality_plan_v2b.json"
QUALITY_AUDIT_PATH = campaign.OUTPUT_ROOT / "quality_final_audit_v2b.json"
