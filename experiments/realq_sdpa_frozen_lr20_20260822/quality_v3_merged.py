#!/usr/bin/env python3
"""KL/PPL and ten-task QA for the merged SDPA 40-checkpoint release."""
...
core = immutable.core
QUALITY_ID = "realq-sdpa-frozen-run15-lr20-quality-20260822-v3-merged"
QUALITY_PLAN_PATH = campaign.OUTPUT_ROOT / "quality_plan_v3_merged.json"
QUALITY_AUDIT_PATH = campaign.OUTPUT_ROOT / "quality_final_audit_v3_merged.json"
