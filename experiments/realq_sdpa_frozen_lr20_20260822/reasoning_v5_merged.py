#!/usr/bin/env python3
"""Three-task reasoning evaluation for the final merged SDPA release."""
...
core = immutable.core
REASONING_ID = "realq-sdpa-frozen-run15-lr20-reasoning-20260822-v5-merged"
REASONING_PLAN_PATH = campaign.OUTPUT_ROOT / "reasoning_plan_v5_merged.json"
REASONING_AUDIT_PATH = campaign.OUTPUT_ROOT / "reasoning_final_audit_v5_merged.json"
