#!/usr/bin/env python3
"""Three-task reasoning evaluation for the merged SDPA checkpoint release."""
...
from experiments.realq_sdpa_frozen_lr20_20260822 import formal_merged_v3 as formal


core = immutable.core
REASONING_ID = "realq-sdpa-frozen-run15-lr20-reasoning-20260822-v3-merged"
REASONING_PLAN_PATH = campaign.OUTPUT_ROOT / "reasoning_plan_v3_merged.json"
REASONING_AUDIT_PATH = campaign.OUTPUT_ROOT / "reasoning_final_audit_v3_merged.json"
...
def _build_plan() -> dict[str, Any]:
    ...
    body["protocol"] = {
        **body["protocol"],
        ...
        "formal_sources": "32 V2b non-Q32 + 8 V3 Q32 hessian-accum-16",
        "formal_calibration_tokens_are_exact_gptaq_guidedquant_files": True,
    }
    body["reasoning_plan_fingerprint"] = base._canonical_sha256(body)
    return body
