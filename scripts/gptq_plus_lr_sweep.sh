...
GRAD_LRS_STR=${GRAD_LRS:-"0.00002 0.00003 0.00005 0.00007 0.0001 0.0002 0.0003"}
...
GRAD_REFRESH_LOSS=${GRAD_REFRESH_LOSS:-residual_kl}
FINAL_LAYER_GRAD_LR=${FINAL_LAYER_GRAD_LR:-0.00003}
