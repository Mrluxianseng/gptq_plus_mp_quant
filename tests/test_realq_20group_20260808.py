...
audit = importlib.import_module("experiments.realq_20group_20260808.audit")
watch_completion = importlib.import_module(
    "experiments.realq_20group_20260808.watch_completion"
)
...
def test_worker_module_entry_preserves_repository_import_path():
    assert campaign.MODULE == "experiments.realq_20group_20260808.campaign"
...
def test_plan_serializes_full_resolved_config(tmp_path: Path, monkeypatch):
    ...
    assert payload["campaign_id"].endswith("-v5")
